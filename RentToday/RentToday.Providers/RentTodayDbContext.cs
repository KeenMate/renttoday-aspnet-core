...
{
    public partial class RentTodayDbContext : DbContext
    {
        public RentTodayDbContext()
        {
        }

        public RentTodayDbContext(DbContextOptions<RentTodayDbContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<PaymentP201701> PaymentP201701 { get; set; }
        public virtual DbSet<PaymentP201702> PaymentP201702 { get; set; }
        public virtual DbSet<PaymentP201703> PaymentP201703 { get; set; }
        public virtual DbSet<PaymentP201704> PaymentP201704 { get; set; }
        public virtual DbSet<PaymentP201705> PaymentP201705 { get; set; }
        public virtual DbSet<PaymentP201706> PaymentP201706 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Database=renttoday;Server=db-01.km8.es;Port=5432;User Id=fjakab;Password=Sla kacka do shopinu.");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.CustomerId)
                    ...
                    .HasDefaultValueSql("nextval('customer_customer_id_seq1'::regclass)");
            ...
            modelBuilder.Entity<PaymentP201701>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_01");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_01_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_01_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201701)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_01_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201701)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_01_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201701)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_01_staff_id_fkey");
            });

            modelBuilder.Entity<PaymentP201702>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_02");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_02_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_02_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201702)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_02_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201702)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_02_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201702)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_02_staff_id_fkey");
            });

            modelBuilder.Entity<PaymentP201703>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_03");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_03_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_03_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201703)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_03_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201703)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_03_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201703)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_03_staff_id_fkey");
            });

            modelBuilder.Entity<PaymentP201704>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_04");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_04_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_04_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201704)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_04_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201704)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_04_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201704)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_04_staff_id_fkey");
            });

            modelBuilder.Entity<PaymentP201705>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_05");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_05_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_05_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201705)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_05_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201705)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_05_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201705)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_05_staff_id_fkey");
            });

            modelBuilder.Entity<PaymentP201706>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("payment_p2017_06");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("idx_fk_payment_p2017_06_customer_id");

                entity.HasIndex(e => e.StaffId)
                    .HasName("idx_fk_payment_p2017_06_staff_id");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.PaymentP201706)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_06_customer_id_fkey");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.PaymentP201706)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_06_rental_id_fkey");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PaymentP201706)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("payment_p2017_06_staff_id_fkey");
            });
